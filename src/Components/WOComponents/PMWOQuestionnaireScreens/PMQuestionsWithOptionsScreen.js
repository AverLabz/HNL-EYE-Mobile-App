...
const PMQuestionsWithOptionsScreen = (param) => {

  const { setSetSelected, setSelected, getCurretLocation, imageSource, setImageSource, saveToAsyncStoragePMWOQuestionsData, setIsLoadingActivityIncatorForImage, ConvertImageToBase64 } = React.useContext(DataContext)
...
export default PMQuestionsWithOptionsScreen;
// define your styles
