...
import { Alert, FlatList, LogBox, PermissionsAndroid, SafeAreaView, ScrollView, StatusBar, Text, TouchableOpacity, View, ActivityIndicator } from 'react-native';
...
import PMQuestionsWithInputScreen from '../PMWOQuestionnaireScreens/PMQuestionsWithInputScreen';
import PMQuestionsWithOptionsScreen from '../PMWOQuestionnaireScreens/PMQuestionsWithOptionsScreen';

const PMWOQuestionnaireQuestionsMainPage = ({ route, navigation }) => {
    let dropDownAlertRef = useRef(null);
    const { setImageSource, saveToAsyncStoragePMWOQuestionsData, isLoadingActivityIncatorForImage } = useContext(DataContext)
    ...
    const submitQuestionnaires = (counter) => {
        ...
        // }
            ...
            dropDownAlertRef.alertWithType('success', 'Alert', "You have completed questionnaire successfully");
            ...
            saveToAsyncStoragePMWOQuestionsData(route.params.questionsDatoFromAsyncfromAsyncStorage);
    ...
    useEffect(() => {
        ...
        // check the GPS Location Is On or Not
        try {
            ...
            <SafeAreaView style={{flex:1}}>
                ...
                >
                    ...
                    {QuestionScreenData.answerTypeName == "Dropdown" ?
                        <PMQuestionsWithOptionsScreen wOQuestionnaireQuestionsMainPageItemData={route.params.WOQuestionnaireQuestionsMainPageItemData} questionsDatoFromAsyncfromAsyncStorage={route.params.questionsDatoFromAsyncfromAsyncStorage} navigation={navigation} WOId={route.params.WOId} siteCode={route.params.siteCode} QuestionsInitialData={QuestionsInitialData} questionScreenData={QuestionScreenData} SetSelectOption={SetSelectOption}></PMQuestionsWithOptionsScreen>
                        : <PMQuestionsWithInputScreen wOQuestionnaireQuestionsMainPageItemData={route.params.WOQuestionnaireQuestionsMainPageItemData} questionsDatoFromAsyncfromAsyncStorage={route.params.questionsDatoFromAsyncfromAsyncStorage} navigation={navigation} WOId={route.params.WOId} siteCode={route.params.siteCode} QuestionsInitialData={QuestionsInitialData} questionScreenData={QuestionScreenData}></PMQuestionsWithInputScreen>}
...
export default PMWOQuestionnaireQuestionsMainPage