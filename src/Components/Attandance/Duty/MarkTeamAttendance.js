...
const MarkTeamAttendance = ({ navigation }) => {
  ...
  // setCurrentLongitude(location.coords.longitude);
    ...
    setLoading(true);
    var url =
      JsonServer.baseURL + "services/app/Attendance/GetAllUserAttendanceAbsentUser?StartDate=" + moment(new Date()).format("YYYY-MM-DD") + "&EndDate=" + moment(new Date()).format("YYYY-MM-DD") + "&MaxResultCount=10000"
