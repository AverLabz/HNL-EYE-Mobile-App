...
const LocationForEndDuty = ({ navigation, route }) => {

  const { getCurretLocation, getAPICall, postRequest, checkDistance } = useContext(DataContext)
...
export default LocationForEndDuty;
